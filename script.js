    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "תורה ישראלית לכתחילה משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
        ...
        function initContactForm() {
            ...
            try {
                ...
                const response = await fetch(endpoint, {
                    ...
                    body: JSON.stringify({
                        websiteId: '81aa191d-3aca-4a90-ab3b-9ab8631e809a',
                        name: data.name,
                        email: data.email,
